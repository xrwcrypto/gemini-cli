...
export class ClearcutLogger {
  ...
  logStartSessionEvent(event: StartSessionEvent): void {
    const data = [
      ...
      {
        EventMetadataKey: EventMetadataKey.GEMINI_CLI_START_SESSION_EMBEDDING_MODEL,
      ...
      {
        EventMetadataKey: EventMetadataKey.GEMINI_CLI_START_SESSION_APPROVAL_MODE,
        value: event.approval_mode,
      },
      {
        EventMetadataKey: EventMetadataKey.GEMINI_CLI_START_SESSION_API_KEY_ENABLED,
        value: event.api_key_enabled.toString(),
      },
      {
        EventMetadataKey: EventMetadataKey.GEMINI_CLI_START_SESSION_VERTEX_API_ENABLED,
        value: event.vertex_ai_enabled.toString(),
      },
      {
        EventMetadataKey: EventMetadataKey.GEMINI_CLI_START_SESSION_DEBUG_MODE_ENABLED,
      ...
      {
        EventMetadataKey: EventMetadataKey.GEMINI_CLI_START_SESSION_TELEMETRY_ENABLED,
        value: event.telemetry_enabled.toString(),
      },
      {
        EventMetadataKey: EventMetadataKey.GEMINI_CLI_START_SESSION_TELEMETRY_LOG_USER_PROMPTS_ENABLED,
